    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', models.ManyToManyField(to='experience.Courses')),
                ('items', models.ManyToManyField(to='experience.Items')),
                ('social_networks', models.ManyToManyField(to='socialnetworks.SocialNetworks')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('work', models.ManyToManyField(to='experience.Works')),
            ],
            options={
