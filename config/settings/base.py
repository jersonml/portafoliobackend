...
LOCAL_APPS = [
    'portafoliobackend.users.apps.UsersAppConfig',
    'portafoliobackend.experience.apps.ExperienceAppConfig',
    'portafoliobackend.socialnetworks.apps.SocialNetworksAppConfig',
]
